            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <input type="text" name="info[rolename]" data-rule="required" size="20" value=""  class="required">
                    </td>
                </tr>
                <tr>
                    <td>
                        <label for="j_dialog_code" class="control-label x90">描述：</label>
                        <textarea name="info[description]" cols="20" class="form-control" style="width: 337px; margin: 0px; height: 50px;"></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
