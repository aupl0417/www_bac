...
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" action="{:url('finance/orderdetail')}" method="post">
...
<div class="bjui-pageContent tableContent">
    <table data-toggle="tablefixed"  data-nowrap="true" data-width="130%">
        ...
        <tr>
            ...
            <td align="center" colspan="2">区级推荐人</td>
...
<!--        </tr>-->
        ...
        <tr>
            ...
            <td align="center" colspan="2"  width="240">
                ...
                <a class="btn btn-red" href="{:url('payment/finance/orderstop',['id'=>$vo.ao_id])}" data-toggle="dialog" mask="true" data-width="600" data-height="250" data-confirm-msg="确定要启用选中项吗？"><span>驳回</span></a>
                {else /}
                <a class="btn btn-green  {eq name="$vo.ao_state" value="-1"}disabled{/eq}" href="{:url('payment/finance/accountdetails',['ipt_order_id'=>$vo.ao_order_id])}" data-toggle="navtab"><span>查看明细</span></a>
