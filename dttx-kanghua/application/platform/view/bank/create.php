            ...
            <tbody>
                <tr>
                    <td>
                        ...
                        <input type="text" name="name" data-rule="required;length[4~]" size="20" value="">
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <input type="radio" name="state" class="shopType" data-toggle="icheck" value="0" data-label="禁用">
                    </td>
                </tr>
                <tr>
                    <td>
                        ...
                        <input type="radio" name="type" class="shopType" data-toggle="icheck" value="1" data-label="第三方支付平台">
                    </td>
                </tr>
            </tbody>
        </table>
