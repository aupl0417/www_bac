    ...
    <script type="text/javascript">
        $(function() {
            BJUI.init({
                ...
                loginInfo    : { url:'login/index', title:'登录', width:400, height:200}, // 会话超时后弹出登录对话框
...
<!--                <li><a href="#">消息 <span class="badge">4</span></a></li>-->
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">{$Think.cookie.username} <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="{:url('user/userprofile')}" data-toggle="dialog" data-id="System_profile" data-mask="true" data-width="600" data-height="400">&nbsp;<span class="glyphicon glyphicon-user"></span> 我的资料</a></li>
                        <li class="divider"></li>
                        <li><a href="{:url('login/remove')}" class="red">&nbsp;<span class="glyphicon glyphicon-off"></span> 注销登陆</a></li>
                    </ul>
                </li>
