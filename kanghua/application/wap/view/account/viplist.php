...
<div class="popover popover-links modal-in mx-pop">
    ...
    <div class="popover-inner">
        <div class="list-block bg_fff">
            <div class="solid_b"><a href="{:url('account/viplist',['m'=>1])}" class="list-button item-link rfs14 external">本月</a></div>
            <div class="solid_b"><a href="{:url('account/viplist',['m'=>2])}" class="list-button item-link rfs14 external">上月</a></div>
            <div class="solid_b"><a href="{:url('account/viplist',['m'=>3])}" class="list-button item-link rfs14 external">近三个月</a></div>
        </div>
    </div>
</div>
<!--导航弹出框-->
    ...
    <div data-page="case" class="page">
        <div class="page-content bg_gray">
            ...
            <div class="list-box rpd15 bg_fff solid_b">
                <div class="over">
                    <div class="pull-left rfs16 c_333">推广收益-订单<span class="c_999">({$vo.ad_order_id})</span></div>
                </div>
